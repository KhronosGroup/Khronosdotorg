...
*   **LLMs**: We use third-party Artificial Intellgent (AI) Large Language Models (LLM), [ChatGPT](https://openai.com/policies/row-privacy-policy/), [Claude](https://privacy.anthropic.com/en/articles/9301722-updates-to-our-acceptable-use-policy-now-usage-policy-consumer-terms-of-service-and-privacy-policy), [GitHub CoPilot](https://copilot.github.trust.page), and [Zoom AI](https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0057861).
*   **App Stores**: We use the [Apple App Store](https://www.apple.com/legal/privacy/data/en/app-store/) to allow download of our iOS and macOS apps and the [Google Play Store](https://play.google/developer-content-policy/) to allow download of our Android apps. Our Apps do not share data with any third parties. Our Apps have no embedded analytics, do not use any advertising networks, and do not use third-party SDKs that collect any of your data. 
...
This version of the privacy policy was last updated on July 14, 2025. This [Privacy Policy Changelog](https://github.com/KhronosGroup/Khronosdotorg/commits/main/legal/privacy-policy.md) is available on GitHub.
